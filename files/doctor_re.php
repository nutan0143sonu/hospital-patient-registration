...
<body width="100%" height="100%">
 ...
 <div class="P_page"> 	
            <form action="doctor.php" align="left" method="post">
	 
	       <center><font size="7" align="center" color="white">Doctor Register </font></center>
		   
		      
		  <br><br><br> <input type="text" name=" name" placeholder="Enter Full Name" size="20px"  required />

		   
		   <br><br><input type="text" name="specilization" placeholder="Enter The Specilization" size="20px" />
		   <br><br><input type="text" name="working_hour" placeholder="Enter The Working Hour " size="20px" />
		   <br><br><input type="text" name="working_day" placeholder="Enter The Day Of Sitting " size="20px" />
		   <br><br><input type="text" name="dr_room_no" placeholder="Enter The Room No For Sitting" size="20px" />
		   <br><br><input type="text" name="mobile_no" placeholder="Mobile No."  required/>
		   <br><br><input type="text" name="age" placeholder="Enter The Age" size="20px" required/>
		   <br><br><input type="text" name="email_id" placeholder="Enter Dr. Email ID" size="20px" required/>
		  ...
		  <br><br><font color="white" size="5"><input type="radio" name="gender" value="Male"  required/>Male                         
			  ...
			  <select name="month">
				 ...
				 <br><br><input type="text" name="doctor_id" placeholder="Enter Doctor Id" " required/>
   ...
   if($_POST["submit"]=="Submit")
   {
		...
		$do="insert into doctor_registration(name,doctor_id,password,specilization,degree,working_hour,working_day,dr_room_no,mobile_no,age,email_id,address,gender,marital_status,dob)values
		('".$name."','".$did."','".$pass."','".$specilization."','".$degree."','".$working_hour."','".$working_day."','".$drn."','".$mobileno."','".$age."','".$email."','".$address."','".$gender."','".$ms."','".$dob."')";
		
          if(mysql_query($do))
		  {
		  echo'<script type="text/javascript">'; 
           echo 'alert("The Record Of Doctor Is Inserted")'; 
           echo '</script>';
		  }
		  else
		  echo mysql_error();		
