...
<div class="middle">
   <form align="center" method="post" action="recepnist_d.php">
	    
		      <font color="white" align="center" size='7' >Doctor Id</font><br><br><br>
			  <input type="text" name="pateintid" placeholder="User Id Of Doctor" required/><br><br><br>
         ...
         {	
			 ...
			 $sq="select * from doctor_registration where doctor_id='$user'";
			 $q=mysql_query($sq);
			 $res=mysql_fetch_array($q);

			 
			 if($res['doctor_id']==$user)
			 {
			      header("location: r_doctor.php?id=$user&");
			 }
			 else
			 {
                 mysql_error();
